...
use Utilisateur\UtilisateurBundle\Form\formProfilType;
...
class ProfileController extends Controller
{
    ...
    */
    ...
    {
        $form = $this->createForm(new formProfilType(), $entity, array(
            'action' => $this->generateUrl('utilisateur_update_profil', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
