...
use Utilisateur\UtilisateurBundle\Form\formNotifType;

/**
 * Utilisateur controller.
 *
 */
class notifCompteController extends Controller
{
    ...
    {
        $form = $this->createForm(new formno(), $entity, array(
    ...
    public function editAction()
    {
        ...
        return $this->render('UtilisateurBundle:Default:notification.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new formNotifType(), $entity, array(
            'action' => $this->generateUrl('utilisateur_update_notification', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('utilisateur_notification', array('id' => $id)));
        }
