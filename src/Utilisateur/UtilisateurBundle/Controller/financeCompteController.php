...
use Utilisateur\UtilisateurBundle\Form\formFinanceType;

/**
 * Utilisateur controller.
 *
 */
class financeCompteController extends Controller
{
    ...
    public function editAction()
    {
        ...
        return $this->render('UtilisateurBundle:Default:finance.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new formFinanceType(), $entity, array(
            'action' => $this->generateUrl('utilisateur_update_finance', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));

        $form->add('submit', 'submit', array('label' => 'Mettre à jour les données','attr'=>array('class'=>'btn btn-sm btn-primary pull-right')));
    ...
    public function updateAction(Request $request)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('utilisateur_finance', array('id' => $id)));
        }
